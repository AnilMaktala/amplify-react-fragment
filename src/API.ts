...
export type blogsWithPostDataUsingFragmentQueryVariables = {
  filter?: ModelBlogFilterInput | null,
  limit?: number | null,
  nextToken?: string | null,
};

export type blogsWithPostDataUsingFragmentQuery = {
  listBlogs?:  {
    __typename: "ModelBlogConnection",
    items:  Array< {
      __typename: "Blog",
...
export type blogsWithPostDataQueryVariables = {
  filter?: ModelBlogFilterInput | null,
  limit?: number | null,
  nextToken?: string | null,
};

export type blogsWithPostDataQuery = {
  listBlogs?:  {
    __typename: "ModelBlogConnection",
    items:  Array< {
      __typename: "Blog",
...
export type blogDetailsFragment = {
  __typename: "Blog",
  id: string,
  name: string,
  posts?:  {
